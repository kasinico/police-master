...
@section('content')
  <section class="content">
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Fill in the required details to add a new staff</h4>
                    ...
                    <div class="select">
                      <label>Role</label>
                        <select class="form-control" name="role">
                            <option></option>
                            <option value="Administrator">Police Administrator</option>
                            <option value="Supervisor">Police Supervisor</option>
                            <option value="Staff">Police Staff</option>
                        </select>
                    </div>
                </div>
